...
<head>
    ...
    <!-- custom Css-->
    <link href="<?php echo e(asset('css/custom.min.css')); ?>" rel="stylesheet" type="text/css" />
...
<body>
                            ...
                            <div class="row g-0">
                                        ...
                                        <div class="position-relative h-100 d-flex flex-column">
                                            <div class="mb-4">
                                                <a href="index.html" class="d-block">
                                                    <img src="<?php echo e(asset('images/logo-light.png')); ?>" alt="" height="18">
                                                </a>
                                            </div>
                                            <div class="mt-auto">
                                                <div class="mb-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="mt-4">
                                            <form action="<?php echo e(url('home/')); ?>">
    ...
    <!-- password-addon init -->
    <script src="<?php echo e(asset('js/pages/password-addon.init.js')); ?>"></script>
</body>


</html><?php /**PATH C:\xampp\htdocs\plantilla\resources\views/welcome.blade.php ENDPATH**/ ?>